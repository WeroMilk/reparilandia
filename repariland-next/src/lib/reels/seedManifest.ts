...
export const SEED_REELS_MANIFEST: ReelsManifest = {
  ...
  items: [
    {
      id: 'reel-video-2026-06-08',
      title: 'Reparilandia',
      externalUrl: 'https://drive.google.com/file/d/14koetuV6OpmWXa-VfUENMOb-Lb0e6-6Y/view',
      videoUrl: '/reels/reel-video-2026-06-08.mp4',
      durationSec: 60,
      likeCount: 0,
      createdAt: '2026-06-08T12:09:12.000Z',
    },
    {
